    ...
    return (
        ...
        >
            ...
            <span className="absolute inset-0 rounded-full overflow-hidden">
                <span
                    className="absolute inset-0 block blur-xl transition-transform duration-1000"
                    style={{
                        background:
            ...
            <span
                className="absolute inset-0 pointer-events-none select-none group-hover:translate-x-[50%] transition-transform duration-700"
                style={{
                    background:
                        'linear-gradient(135deg, rgb(122, 105, 249), rgb(242, 99, 120), rgb(245, 131, 63))',
                    mixBlendMode: 'screen',
            ...
            <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
                ...
                <span className="bg-gradient-to-b ml-1.5 cursor-pointer dark:from-white dark:to-white/50 tracking-tighter from-neutral-950 to-neutral-950/50 bg-clip-text text-lg text-transparent group-hover:scale-105 transition transform-gpu">
                    {children || "Generate Wireframe"}
                </span>
            </span>
        </button>
    );
